...
\end{align}
The above line equations have no point of intersection as for no value of $\lambda_1,\lambda_2$ both the equations (\ref{eq:3}) and (\ref{eq:4}) are equal.\par
If the two line intersect then,equation (\ref{eq:3})=(\ref{eq:4}) i.e.
\begin{align}
...
\end{align}
Combining the equations (\ref{eq:33}) and (\ref{eq:35}) in matrix form,using equation (\ref{eq:36}), we get
\begin{align}
...
\end{align}
Using the equation (\ref{eq:1}) and (\ref{eq:2}), we get the points as $A=\frac{1}{6}\myvec{17\\1\\17}$ and $B=\frac{1}{6}\myvec{26\\1\\8}$ on the line $L_1$,$L_2$ respectively.
