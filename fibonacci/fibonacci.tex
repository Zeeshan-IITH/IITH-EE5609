...
\begin{align}
    ...
    \text{So the values are }
    \lambda_1=\frac{11}{6} \text{ and }\lambda_2=\frac{7}{6}\\
    \intertext{Using the equation (1.0.1) and (1.0.2), we get the points as }\frac{1}{6}\myvec{17\\1\\17} \text{and} \frac{1}{6}\myvec{26\\1\\8} \text{on the line $L_1$,$L_2$ respectively}\notag
\end{align}
