...
\begin{align}
    ...
    \intertext{Therefore the $n^t{^h}$ fibonacci number is the element in the first row,first column of $\vec{F^n{^+}{^1}}$,where $n\geq2$.The general form will be}
    \vec{F^n{^+}{^1}}=\myvec{F_n & F_n{_-}{_1}\\F_n{_-}{_1} & F_n{_-}{_2}}
\end{align}
\end{document}
