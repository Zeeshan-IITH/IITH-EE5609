...
\begin{align}
    ...
    Y=\myvec{h_0&0&0&.&.&0&0\\h_1&h_0&0&.&.&0&0\\h_2&h_1&h_0&.&.&0&0\\.&.&.&.&.&.&.\\h_{n-1}&h_{n-2}&n_{n-3}&.&.&h_1&h_0\\h_{m-1}&h_{m-2}&h_{m-3}&.&.&h_{m-n}&h_{m-n-1}\\0&h_{m-1}&h_{m-2}&.&.&h_{m-n+1}&h_{m-n}\\0&0&h_{m-1}&.&.&h_{m-n+2}&h_{m-n+1}\\.&.&.&.&.&.&.\\0&0&0&.&.&0&h_{m-1}}\myvec{x_0\\x_1\\x_2.\\.\\.\\x_{n-1}}
\end{align}
Therefore we can write equation \eqref{eq:1} in matrix form as $\vec{Y}=\vec{H}\vec{X}$ where
\begin{align}
    \vec{H}=\myvec{h_0&0&0&.&.&0&0\\h_1&h_0&0&.&.&0&0\\h_2&h_1&h_0&.&.&0&0\\.&.&.&.&.&.&.\\h_{n-1}&h_{n-2}&n_{n-3}&.&.&h_1&h_0\\h_{m-1}&h_{m-2}&h_{m-3}&.&.&h_{m-n}&h_{m-n-1}\\0&h_{m-1}&h_{m-2}&.&.&h_{m-n+1}&h_{m-n}\\0&0&h_{m-1}&.&.&h_{m-n+2}&h_{m-n+1}\\.&.&.&.&.&.&.\\0&0&0&.&.&0&h_{m-1}}
\end{align}
\end{document}
