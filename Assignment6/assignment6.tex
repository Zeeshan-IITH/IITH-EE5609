...
Let the equation of the coincident line be $mx-y+c=0$.The quadratic equation will be
\begin{align}
    \brak{mx-y+c}^2=0\\
    m^2x^2-2mxy+y^2+2cmx-2cy+c^2=0\\
    \vec{x}^T\myvec{m^2&-m\\-m&1}\vec{x}+2\myvec{cm&-c}\vec{x}+c^2=0\label{eq:2}
\end{align}
Comparing the equations \eqref{eq:1} and \eqref{eq:2},we get
\begin{align}
    m=2,c=-3
\end{align}
